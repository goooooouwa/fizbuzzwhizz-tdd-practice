...
function testFizBuzzWhizz(){
  ...
  const thirdSpeicalNumber = 7;

	const result = fizBuzzWhizzModule.fizBuzzWhizz(firstSpecialNumber, secondSpecialNumber, thirdSpeicalNumber) === expectedResult ? 'test passed.' : 'test failed.';
  console.log(result);
}
